...
Built with [Jekyll](https://jekyllrb.com/) and hosted on [GitHub Pages](https://docs.github.com/en/pages). Reading data comes from Calibre Web and manual entries; knitting projects from Ravelry. Webmentions sent and received via [webmention.io](https://webmention.io) and [jekyll-webmention_io](https://github.com/aarongustafson/jekyll-webmention_io). Colors are [Flexoki](https://stephango.com/flexoki) by Steph Ango. Dark and light modes follow your system preference but can be toggled manually.

I also keep a [/uses page](/uses/) listing the hardware, software, and other tools I rely on.